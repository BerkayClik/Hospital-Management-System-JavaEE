    ...
    <div id="content">
        ...
        <div class="main-content">
            <div class="showAvailability">
                ...
                <form class="" action="showRoomAvailability2" method="post" style="width: 40%; margin:0 auto; position: relative">
                    ...
                    <button type="button" class="btn btn-outline-secondary" style="position: absolute; right: 0; bottom: 35px; width: 84.688px;" onclick="reset()">Reset</button>
            ...
            <div class="reserve">
                ...
                <%
                out.println("<p style=\"margin-top: 2em; text-align: center; color: black\">" + "Click the button to reserve " + roomName + " after entering patient's email ");
                %>
                <form class="" action="reserveRoom" method="post" style="">
